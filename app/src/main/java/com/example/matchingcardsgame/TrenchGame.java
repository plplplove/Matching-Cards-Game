...
public class TrenchGame extends AppCompatActivity {
    ...
    private int[] images = {
            R.drawable.trench_image1, R.drawable.trench_image2, R.drawable.trench_image3,
            R.drawable.trench_image4, R.drawable.trench_image5, R.drawable.trench_image6
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trench_game);
    ...
    private void setupCards() {
        ...
        for (int i = 0; i < cards.size(); i++) {
            ...
            card.setImageResource(R.drawable.trench_mainimage);
    ...
    private void onHomeClick() {
        ...
        showCustomDialog(R.layout.dialog_exit_home,
                () -> {
                    Intent intent = new Intent(TrenchGame.this, MainActivity.class);
    ...
    private void restartGame() {
        Intent intent = new Intent(TrenchGame.this, TrenchGame.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
        finish();
    }
    ...
    private void goToMenu() {
        Intent intent = new Intent(TrenchGame.this, SelectGameMenu.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
        finish();
    }
