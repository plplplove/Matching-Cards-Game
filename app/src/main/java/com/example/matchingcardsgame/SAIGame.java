...
public class SAIGame extends AppCompatActivity {
    ...
    private int[] images = {
            R.drawable.sai_image1, R.drawable.sai_image2, R.drawable.sai_image3,
            R.drawable.sai_image4, R.drawable.sai_image5, R.drawable.sai_image6
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saigame);
    ...
    private void setupCards() {
        ...
        for (int i = 0; i < cards.size(); i++) {
            ...
            card.setImageResource(R.drawable.sai_mainimage);
    ...
    private void onHomeClick() {
        ...
        showCustomDialog(R.layout.dialog_exit_home,
                () -> {
                    Intent intent = new Intent(SAIGame.this, MainActivity.class);
    ...
    private void restartGame() {
        Intent intent = new Intent(SAIGame.this, SAIGame.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
        finish();
    }
    ...
    private void goToMenu() {
        Intent intent = new Intent(SAIGame.this, SelectGameMenu.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
        finish();
    }
