...
public class ClancyGame extends AppCompatActivity {
    ...
    private int[] images = {
            R.drawable.clancy_image1, R.drawable.clancy_image2, R.drawable.clancy_image3,
            R.drawable.clancy_image4, R.drawable.clancy_image5, R.drawable.clancy_image6
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clancy);
    ...
    private void setupCards() {
        ...
        for (int i = 0; i < cards.size(); i++) {
            ...
            card.setImageResource(R.drawable.clancy_mainimage);
    ...
    private void onHomeClick() {
        ...
        showCustomDialog(R.layout.dialog_exit_home,
                () -> {
                    Intent intent = new Intent(ClancyGame.this, MainActivity.class);
    ...
    private void restartGame() {
        Intent intent = new Intent(ClancyGame.this, ClancyGame.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
        finish();
    }
    ...
    private void goToMenu() {
        Intent intent = new Intent(ClancyGame.this, SelectGameMenu.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
        finish();
    }
